<template>
  <div>
    <div class="shopcart">
      <div class="content">
        <div class="content-left" @click="triggerShowCar">
      ...
      <transition name="move">
        <div class="shopcart-list" v-if="carShow">
    ...
    <div class="list-mask" v-if="carShow" @click="triggerShowCar"></div>
  </div>
</template>
    ...
    export default {
        ...
        computed: {
            ...
            payClass() {
              ...
              const minPrice = this.shopInfo.minPrice;
            ...
            carShow() {
              ...
              if (this.isShowCar) {
                this.$nextTick(() => {
                  /*if (!this.scrollCar) {//BScroll实现为一个单例对象      不知道为啥就是不管用。先放着吧
                    this.scrollCar = new BScroll('.list-content', {
                      click: true
                    });
                  } else {
                    console.log(this.scrollCar);
                    this.scrollCar.refresh();
                  }*/
